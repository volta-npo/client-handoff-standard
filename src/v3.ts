export const v3 = {
  "productName": "Client Handoff Standard",
  ...
  "capabilities": [
    "Domain-specific workbench: Client Handoff Binder",
    "Operational table: Handoff assets",
  ...
  "releaseChecklist": [
    ...
    "Owner Operability reaches production threshold",
    "Access Safety is documented with evidence",
    "Support Readiness has no unresolved blocker",
    "Owner manual verified",
    "Access checklist verified",
    "30-day support plan verified"
  ],
  "operations": [
