# Security Policy: Client Handoff Standard

## Data handled

This local-first product may contain student and chapter data. Data stays in the browser unless a user exports it.
...
- For this product's domain, review these gates before handoff: No raw passwords, Critical docs required, Unresolved blockers prevent export.
